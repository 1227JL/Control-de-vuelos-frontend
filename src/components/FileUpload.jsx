...
const FileUpload = ({ children, onFileSelect }) => {
  ...
  return (
    <>
      <p className='px-1 mb-2 text-tiny text-default-500 font-semibold'>Imagen {children}</p>
      <div className={`border border-default-400 p-3 rounded-xl ${isDragActive ? 'bg-default-100 border-default-100' : ''} transition-colors duration-500`}>
        <div {...getRootProps()}>
